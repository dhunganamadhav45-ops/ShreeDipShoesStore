...
const App = {
  ...
  initSidebar(activePage) {
    ...
    const nav = [
      ...
      { label:'INVENTORY' },
      { id:'shoes', icon:'bi-bag-fill', text:'Shoes', sub:[
        { text:'View All Shoes', href:'shoes.html' },
      ]},
      { id:'stock', icon:'bi-boxes', text:'Stock', sub:[
      ...
      { id:'purchases', icon:'bi-truck', text:'Purchases', sub:[
        { text:'New Purchase',      href:'purchases.html#new' },
        { text:'Purchase History',  href:'purchases.html' },
      ]},
      { label:'MANAGEMENT' },
      { id:'suppliers', icon:'bi-building',     text:'Suppliers',  href:'suppliers.html' },
      { id:'reports',   icon:'bi-bar-chart-fill',text:'Reports',   href:'reports.html' },
