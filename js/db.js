...
const DB = {
  ...
  _seed() {
    ...
    // Shoes
    this.saveAll('shoes', [
      { id:'sh1',  name:'Air Max 270',        brand:'Nike',        category:'Casual',  size:'9',   colour:'Black/White',  gender:'Men',    purchasePrice:85,  sellingPrice:150, quantity:25, supplierId:'sp1', barcode:'1001', dateAdded:d(20), lastUpdated:d(2), image:'' },
      { id:'sh2',  name:'Ultra Boost 22',     brand:'Adidas',      category:'Running', size:'10',  colour:'Grey',         gender:'Unisex', purchasePrice:90,  sellingPrice:180, quantity:18, supplierId:'sp2', barcode:'1002', dateAdded:d(18), lastUpdated:d(1), image:'' },
      { id:'sh3',  name:'Air Force 1',        brand:'Nike',        category:'Casual',  size:'9.5', colour:'White',        gender:'Unisex', purchasePrice:65,  sellingPrice:110, quantity:4,  supplierId:'sp1', barcode:'1003', dateAdded:d(15), lastUpdated:d(0), image:'' },
      { id:'sh4',  name:'Stan Smith',         brand:'Adidas',      category:'Casual',  size:'8',   colour:'White/Green',  gender:'Unisex', purchasePrice:55,  sellingPrice:95,  quantity:0,  supplierId:'sp2', barcode:'1004', dateAdded:d(14), lastUpdated:d(3), image:'' },
      { id:'sh5',  name:'Chuck Taylor',       brand:'Converse',    category:'Casual',  size:'9',   colour:'Black',        gender:'Unisex', purchasePrice:30,  sellingPrice:65,  quantity:12, supplierId:'sp3', barcode:'1005', dateAdded:d(12), lastUpdated:d(1), image:'' },
      { id:'sh6',  name:'Old Skool',          brand:'Vans',        category:'Casual',  size:'10',  colour:'Black/White',  gender:'Unisex', purchasePrice:35,  sellingPrice:70,  quantity:8,  supplierId:'sp3', barcode:'1006', dateAdded:d(11), lastUpdated:d(2), image:'' },
      { id:'sh7',  name:'Air Jordan 1 High',  brand:'Nike',        category:'Sports',  size:'11',  colour:'Red/Black',    gender:'Men',    purchasePrice:100, sellingPrice:200, quantity:3,  supplierId:'sp1', barcode:'1007', dateAdded:d(10), lastUpdated:d(0), image:'' },
      { id:'sh8',  name:'Superstar',          brand:'Adidas',      category:'Casual',  size:'8.5', colour:'White/Black',  gender:'Women',  purchasePrice:50,  sellingPrice:90,  quantity:15, supplierId:'sp2', barcode:'1008', dateAdded:d(9),  lastUpdated:d(1), image:'' },
      { id:'sh9',  name:'Suede Classic',      brand:'Puma',        category:'Casual',  size:'9',   colour:'Black',        gender:'Men',    purchasePrice:40,  sellingPrice:80,  quantity:2,  supplierId:'sp3', barcode:'1009', dateAdded:d(8),  lastUpdated:d(0), image:'' },
      { id:'sh10', name:'574 Core',           brand:'New Balance', category:'Casual',  size:'10',  colour:'Grey/Navy',    gender:'Men',    purchasePrice:60,  sellingPrice:105, quantity:0,  supplierId:'sp3', barcode:'1010', dateAdded:d(7),  lastUpdated:d(2), image:'' },
      { id:'sh11', name:'RS-X Toys',          brand:'Puma',        category:'Running', size:'9',   colour:'White/Blue',   gender:'Unisex', purchasePrice:55,  sellingPrice:95,  quantity:22, supplierId:'sp4', barcode:'1011', dateAdded:d(6),  lastUpdated:d(1), image:'' },
      { id:'sh12', name:'Pegasus 40',         brand:'Nike',        category:'Running', size:'10',  colour:'Blue',         gender:'Men',    purchasePrice:80,  sellingPrice:135, quantity:30, supplierId:'sp1', barcode:'1012', dateAdded:d(5),  lastUpdated:d(0), image:'' },
      { id:'sh13', name:'Gel-Nimbus 25',      brand:'ASICS',       category:'Running', size:'9.5', colour:'Black/Gold',   gender:'Women',  purchasePrice:95,  sellingPrice:160, quantity:5,  supplierId:'sp4', barcode:'1013', dateAdded:d(4),  lastUpdated:d(1), image:'' },
      { id:'sh14', name:'Classic Leather',    brand:'Reebok',      category:'Casual',  size:'8',   colour:'White',        gender:'Unisex', purchasePrice:45,  sellingPrice:85,  quantity:9,  supplierId:'sp4', barcode:'1014', dateAdded:d(3),  lastUpdated:d(0), image:'' },
      { id:'sh15', name:'Slip-On Pro',        brand:'Vans',        category:'Casual',  size:'9',   colour:'Navy',         gender:'Unisex', purchasePrice:28,  sellingPrice:55,  quantity:0,  supplierId:'sp3', barcode:'1015', dateAdded:d(2),  lastUpdated:d(0), image:'' },
    ]);
